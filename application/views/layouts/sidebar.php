...
<?php if ($this->session->userdata('pais') == 'peru'): ?>
    ...
    <li class="nav-item">
        <a href="<?= base_url('ventas/nueva_cotizacion') ?>" class="nav-link">
            ...
            <p><small class="d-md-inline d-none">Nueva</small> Venta</p>
        </a>
    </li>

    <li class="nav-item">
        <a href="<?= base_url('ventas/listado') ?>" class="nav-link">
    ...
    <li class="nav-item">
        <a href="<?= base_url('produccion') ?>" class="nav-link">
            <i class="nav-icon fas fa-industry"></i>
            <p>Costura (Producción)</p>
        </a>
    </li>
    ...
    <li class="nav-item">
        <a href="<?= base_url('Inventario/kardex_peru') ?>" class="nav-link">
...
<?php if ($this->session->userdata('pais') == 'bolivia'): ?>
    <li class="nav-header">MÓDULO BOLIVIA</li>
    ...
    <li class="nav-item">
        <a href="<?= base_url('ventas_bolivia/listado') ?>" class="nav-link">
            <i class="nav-icon fas fa-clipboard-list"></i> 
            <p>Listado de Ventas</p>
        </a>
    </li>
    ...
    <li class="nav-item">
        <a href="<?= base_url('productos_bolivia') ?>" class="nav-link">
            <i class="nav-icon fas fa-cubes"></i>
            <p>Productos Bolivia</p>
        </a>
    </li>

    <li class="nav-item">
        <a href="<?= base_url('distribuidores') ?>" class="nav-link">
    ...
    <li class="nav-item">
        <a href="<?= base_url('Inventario/kardex_bolivia') ?>" class="nav-link">
            <i class="nav-icon fas fa-barcode"></i>
            <p>Kardex de Inventario</p>
        </a>
    </li>
    ...
    <li class="nav-item">
        <a href="<?= base_url('liquidaciones') ?>" class="nav-link">
            <i class="nav-icon fas fa-calculator"></i>
            <p>Transferencias Alfredo</p>
        </a>
    </li>

    <li class="nav-item">
        <a href="<?= base_url('pagos_distribuidores') ?>" class="nav-link">
            <i class="fas fa-money-bill-wave"></i> <span>Totales Distribuidores</span>
        </a>
    </li>

    <li class="nav-item">
        <a href="<?= base_url('pagos_alfredo') ?>" class="nav-link">
